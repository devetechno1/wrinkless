...
import 'features/blog/controllers/blog_posts_controller.dart';
import 'features/blog/controllers/posts_search_controller.dart';
import 'features/blog/domain/repositories/blog_repo.dart';
import 'features/blog/domain/repositories/posts_repository.dart';
import 'features/blog/domain/repositories/posts_repository_interface.dart';
import 'features/blog/domain/service/posts_service.dart';
import 'features/blog/domain/service/posts_service_interface.dart';
import 'features/loyaltyPoint/domain/repositories/loyalty_point_repository.dart';
import 'features/product/controllers/category_product_controller.dart';
...
Future<void> init() async {
  ...
  // Provider
  sl.registerFactory(() => BlogController(blogService: sl()));
  sl.registerFactory(() => CategoryController(categoryServiceInterface: sl()));
  sl.registerFactory(() => BlogPostsController(postsServiceInterface: sl()));
  sl.registerFactory(() => PostsSearchController(postsServiceInterface: sl()));
  sl.registerFactory(
      () => CategoryProductController(productServiceInterface: sl()));
  ...
  BlogRepository blogService = BlogRepository(dioClient: sl());
  ...
  PostsRepositoryInterface postsRepositoryInterface =
      PostsRepository(dioClient: sl());
  sl.registerLazySingleton(() => postsRepositoryInterface);
  PostsServiceInterface postsServiceInterface =
      PostsService(postsRepositoryInterface: sl());
  sl.registerLazySingleton(() => postsServiceInterface);
